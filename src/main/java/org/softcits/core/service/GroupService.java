...
import org.softcits.core.dao.IChannelDao;
import org.softcits.core.dao.IGroupDao;
...
public class GroupService implements IGroupService{
	...
	public void delete(int id) {
		...
		if(users!=null&&users.size()>0) throw new CmsException("该部门存在用户，不能删除!");
		groupDao.delete(id);
	}
	...
	public void addGroupChannel(int gid, int cid) {
		...
		if(c==null||g==null)throw new CmsException("栏目或用户组不存在!");
