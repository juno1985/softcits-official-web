...
public class TopicController {
	...
	//@ReponseBody返回的是json类型的值，而uploadify只能接受字符串,也不能return String这样的话就会去找视图，所以用HttpServletReponse
	//就能够以String存储的JSON返回，而不是JSON对象
