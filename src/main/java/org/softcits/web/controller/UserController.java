...
import org.softcits.core.dto.UserDto;
...
import org.softcits.core.service.IGroupService;
import org.softcits.core.service.IRoleService;
...
public class UserController {
	...
	public @ResponseBody List<ChannelTree> groupTree(@PathVariable Integer uid,@RequestParam Integer isAdmin) {
		if(isAdmin!=null&&isAdmin==1) {
			System.out.println("-------------------------");
			System.out.print(channelService.generateTree());
			System.out.println("-------------------------");
